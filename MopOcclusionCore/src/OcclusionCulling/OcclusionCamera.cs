...
namespace MopOcclusionCore
{
    class OcclusionCamera : MonoBehaviour
    {
        ...
        void Start()
        {
            MopOcclusionCoreSettings.IsModActive = true;

            switch (MopOcclusionCoreSettings.OcclusionMethod)
            {
                default:
            ...
            MSCLoader.ModConsole.Print("[MOP: Occlusion Core] Camera Script Initialzied!");
        }
        ...
        void SetOcclusionHideDelayTime(long elapsedTime)
        {
            ...
            MopOcclusionCoreSettings.OcclusionHideDelay = toInt;
        }
        ...
        IEnumerator ControlCoroutine()
        {
            while (MopOcclusionCoreSettings.IsModActive)
            {
                ...
                if (lastTick == ticks)
                {
                    MSCLoader.ModConsole.Error("[MOP: Occlusion Core] Occlusion Core stopped working. Trying to restart the now...\n" +
