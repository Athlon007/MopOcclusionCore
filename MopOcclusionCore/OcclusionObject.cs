...
namespace MopOcclusionCore
{
    class OcclusionObject : OcclusionBase
    {
        ...
        {
            while (MopOcclusionCoreSettings.OcclusionHideDelay == -1)
            {
                yield return new WaitForSeconds(1);
            }

            InvokeRepeating("Hide", MopOcclusionCoreSettings.OcclusionSampleDelay, MopOcclusionCoreSettings.OcclusionHideDelay);
        }
        ...
        public void Toggle()
        {
            ...
            bool visible = (IsVisible) || (PlayerDistance < MopOcclusionCoreSettings.MinOcclusionDistance);
